...
public class CursoDAO implements Serializable {
    ...
    public void salvar(Curso curso) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (obterCurso(curso.getIdCurso()) != null) {
    ...
    public void atualizar(Curso curso) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public List<Curso> obterCursos() {
        return obterCursos(true, -1, -1);
    }

    public List<Curso> obterCursos(int maxResults, int firstResult) {
        return obterCursos(false, maxResults, firstResult);
    }

    private List<Curso> obterCursos(boolean all, int maxResults, int firstResult) {
